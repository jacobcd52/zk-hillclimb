#!/bin/bash
# Full regression battery: builds all 17 test binaries (parallel) and runs them
...
TESTS="p3_matmul_selftest p3_rmsnorm_test p3_swiglu_test p3_quant_test p3_bfadd_test p3_rope_test p3_softmax_test p3_gkr_selftest p3_logup_test p3_hawkeye_zk_test zk_gadget_smoke p3_transformer_test zk_layer_smoke p3_transformer_zk_test p3_model_test zk_model_smoke p3_model_zk_test"
echo "=== build ==="
pids=""
for t in $TESTS; do
